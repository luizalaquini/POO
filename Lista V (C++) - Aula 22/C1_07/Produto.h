...
class Produto{
    ...
    */ 
    ...
    public:
    //Construtor
    Produto(int cod, const string& nome, double preco);
    ...
    /*Compara por codigo de barras*/
    friend bool operator==(const Produto& a, const Produto& b);
};
